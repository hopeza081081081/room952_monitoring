...
class YearlyUsedExtended extends StatefulWidget {
  ...
  @override
  _YearlyUsedExtendedState createState() => _YearlyUsedExtendedState();
}

class _YearlyUsedExtendedState extends State<YearlyUsedExtended> {
  @override
          ...
          child: Center(
            child: Container(
              ...
              child: KdGaugeView(
                ...
                animate: true,
                alertSpeedArray: [2000, 4000, 6000],
