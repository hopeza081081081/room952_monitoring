...
class RealtimeAirconControllerMainContent extends StatefulWidget {
  ...
  @override
  _RealtimeAirconControllerMainContentState createState() =>
      _RealtimeAirconControllerMainContentState();
}

class _RealtimeAirconControllerMainContentState
    extends State<RealtimeAirconControllerMainContent>
  ...
  void initState() {
    ...
    if (widget.mqttClient!.clientMQTT.connectionStatus!.state !=
    ...
    aircon1card = EachAirconditionCard(
        rotationController: AnimationController(
            duration: const Duration(milliseconds: 1000), vsync: this)
          ..repeat(reverse: false),
        cardLabel: 'เครื่องปรับอากาศ 1',
        jsonData: dmjAircon1.airconControllerData,
        context: this.context);
    aircon2card = EachAirconditionCard(
        rotationController: AnimationController(
            duration: const Duration(milliseconds: 1000), vsync: this)
          ..repeat(reverse: false),
        cardLabel: 'เครื่องปรับอากาศ 2',
        jsonData: dmjAircon2.airconControllerData,
        context: this.context);
    aircon3card = EachAirconditionCard(
        rotationController: AnimationController(
            duration: const Duration(milliseconds: 1000), vsync: this)
          ..repeat(reverse: false),
        cardLabel: 'เครื่องปรับอากาศ 3',
        jsonData: dmjAircon3.airconControllerData,
        context: this.context);
